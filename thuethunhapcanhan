...
if st.button("Tính thuế"):
    ...
    giam_tru_nguoi_phu_thuoc = so_nguoi_phu_thuoc * 6200000
    ...
    # Không phải nộp thuế nếu thu nhập tính thuế <= 0
    if thu_nhap_tinh_thue <= 0:
        thue = 0
    elif thu_nhap_tinh_thue <= 10000000:
        thue = thu_nhap_tinh_thue * 0.05
    elif thu_nhap_tinh_thue <= 30000000:
        thue = 500000 + (thu_nhap_tinh_thue - 10000000) * 0.10
    elif thu_nhap_tinh_thue <= 60000000:
        thue = 2500000 + (thu_nhap_tinh_thue - 30000000) * 0.20
    elif thu_nhap_tinh_thue <= 100000000:
        thue = 8500000 + (thu_nhap_tinh_thue - 60000000) * 0.30
    else:
        thue = 20500000 + (thu_nhap_tinh_thue - 100000000) * 0.35
    ...
    st.write(
        f"Thu nhập tính thuế: {max(thu_nhap_tinh_thue, 0):,.0f} VNĐ"
    )
